...
func main() {
	dirname := flag.String("crdDir", "_out/manifests/schema/",
		"path to directory with crds from where validation field will be parsed")
...
func generateGoFile(outputDir string, crds map[string]*extv1.CustomResourceDefinition) {
	...
	// Label the file as generated so that linters/formatters don't change it.
	// https://pkg.go.dev/cmd/go#hdr-Generate_Go_files_by_processing_source
	writeOrPanic(file, "// Code generated by crd-generator.go. DO NOT EDIT.\n")

	writeOrPanic(file, "package resources\n\n")
	writeOrPanic(file, "// MigrationControllerCRDs is a map containing yaml strings of all CRDs\n")
	writeOrPanic(file, "var MigrationControllerCRDs map[string]string = map[string]string{\n")
